...
def parse_args():
    ...
    parser.add_argument(
        "--out", type=str,
        default="mask-rcnn-resnet50-se-fpn-hist-match-3x3-glas"
    )
...
def get_model_instance_segmentation(num_classes):
    ...
    # Replace the feature pyramid backbone with a CBAMFeaturePyramidNetwork
    ...
    # this is dense object detection problem so, increase the number
    #  of detection per image
